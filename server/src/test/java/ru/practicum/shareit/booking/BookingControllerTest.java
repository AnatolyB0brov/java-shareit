...
class BookingControllerTest {
    ...
    private final BookingItemDto bookingDto = new BookingItemDto(
            LocalDateTime.now().plusDays(1),
            LocalDateTime.now().plusDays(2),
            1L);
    private final Booking bookingDtoOut = new Booking(
            1L,
            LocalDateTime.now().plusDays(1),
            LocalDateTime.now().plusDays(2),
            new Item(1L, "item"),
    ...
    void saveNewBooking() throws Exception {
        when(bookingService.addBooking(any(), anyLong())).thenReturn(bookingDtoOut);
    ...
    void getAllByBooker() throws Exception {
        when(bookingService.getAllByBooker(anyString(), anyLong()))
